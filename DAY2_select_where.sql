...
where id = 124;
 ...
 -- not : BETWEEN iki mantiksal ifade ile tanımlayabilecegimiz durumlari tek komutla yazabilme imkani verir
...
where maas in(7000,12000);
 ...
 /* -----------------------------------------------------------------------------
  ORNEK8: ismi A harfi ile baslayanlari listeleyiniz
 -----------------------------------------------------------------------------*/   
...
/* ========================================================================== */
    ...
    INSERT INTO kelimeler VALUES (1015, 'hoooooot', 5);
...
-----------------------------------------------------------------------------*/ 
     ...
     select * from kelimeler
     where REGEXP_LIKE(kelime,'^a|^s'); -- Veya '^[as]' kullanılır
