/*======================= CONSTRAINTS - KISITLAMALAR ======================================
 ...
 ========================================================================================*/
   ...
   CREATE TABLE calisanlar
    ...
    INSERT INTO calisanlar VALUES('100010', null, 5000, '2018-04-14'); -- 2. kez null  benzersizlik kisitlamasini bozmaz
    INSERT INTO calisanlar VALUES('10004', 'Veli Han', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10005', 'Mustafa Ali', 5000, '2018-04-14'); 
    INSERT INTO calisanlar VALUES('10006', 'Canan Yaş', NULL, '2019-04-12'); -- maas null olamaz
    INSERT INTO calisanlar VALUES('10003', 'CAN', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- CAN uniqe olmadı, zaten var
    INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14');-- maas int oldugu icin bos verince ne oldugunu analamıyor
	INSERT INTO calisanlar VALUES('', 'cem', 2000, '2018-04-14'); -- '' bunu (hiclik) string kabul eder
    INSERT INTO calisanlar VALUES(null, 'Filiz', 2000, '2018-04-14'); -- primary oldugu icin id null olamaz
...
==============================================================================*/ 
   ...
   CREATE TABLE notlar 
	...
	delete from notlar where id = '124'; -- PARENT
