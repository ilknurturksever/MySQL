...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
   ...
   update tedarikciler
   set irtibat_ismi = 'Ilknur Turksever'
...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
   ...
   -- tedarikcilerin insert'lerini tekrar yapiyoruz
   -- urunlerin insert'lerini tekrar yapiyoruz
...
/*------------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
  ...
  update urunler
  set musteri_isim = (select irtibat_ismi from tedarikciler where firma_ismi = 'Apple') -- ADAM EVE GETIRIR
